...
// NOTE: After DRAGON, player is at level 12 and has about 42 HP and 54 - 64 ATK, so 120 hp and 12 attack is necessary.
// NOTE: Easy Enemy: 0 - 60HP, Medium Enemy: 61 - 90HP, Hard Enemy: 91 - 190HP, MiniBoss - 191+ HP.
// All copyright© of SilverAtom. All rights reserved.

namespace DRAGONLake
{
	class TheDRAGON : Functions
  {
    static void Main(string[] args) 
		{
			...
			//ALL of the game
			Color("purple");
      Writer("THE DRAGON (V0.1.9 PRE-ALPHA UNSTABLE)");
      Writer("START");
			Space(2);
			while(true)
			{
				...
				while(true)	
				{	
					if((Chose == "1" && hasStarted == true) || (Chose == "2" && goAnyway == true))
					{
						while(name != "fuck")
						{
							Read();
								...
								switch(Choose)
								{
							      ...
							      if(newgame == true)
							      	...
							      	Space();
										...
										switch(area)
										{
											...
											case 1:
												...
												Enter();
							      		MonsterEncounter(17, 3, 4, "Mossatle", 1500F, 140, false);
												Space();
												Writer("The springs, infested after centuries of neglect, are crawling with monsters.");
												Enter();
												MonsterEncounter(24, 4, 3, "Shellatty", 700F, 120, false, weight: new int[] {-5, 4, 2, -5});
												Space();
												Writer("Each more deadly than the last.");
												Enter();
												MonsterEncounter(1, 17, 18, "Kamakasemite", 1100F, 0, false);
												Space();
												...
												Writer(name + ": no.", 3);
												Enter();
												MonsterEncounter(30, 7, 5, "Zabuzabuzabuzabuza", 1200F, 500, true, hasPattern: true, hasWeight: false, pattern: new int[] {1, 2, 1, 2, 1, 2, 1, 2, 1, 2, 0}, powerAttackHit: 10, waitTime: 2);
												Space();
												area = 2;
												Save();
											break;
											...
											case 2:
												...
												Enter();
												MonsterEncounter(32, (int) 18, (int) 6, "Goronical Swordsman", (int) EXPNeed/3, 490, true);
												Space();
												...
												Enter();
												Writer("Swordsman: D I E .", 4);
												Enter();
												MonsterEncounter(38, (int) 21, 4, "Duel Swordsman", (int) EXPNeed/3, 540, true);
												stop = true;		
												...
												Enter();
												MonsterEncounter(32, 16, 6, "Guy the Swordsman", (int) EXPNeed/3, 700, true);
												Space();
												...
												Space();
												MonsterEncounter((int) HEARTS, (int) SPE, (int) ATK/2, "Lumpy", (int) EXPNeed/3, (int) GOLD/5, true);
												Space();
												MonsterEncounter((int) HEARTS/2, (int) SPE/2, (int) ATK/2, "Keyrito", (int) EXPNeed/3, (int) GOLD/3, true);
												Space();
												...
												Writer(name + ": ...", 3);
												Enter();
												Writer("Swordsman: Now! It's time to pick up the ", 4);
												Color("bold");
												Writer("HEAT!", 4);
												Enter();
											...
											case 3:
												...
												Enter();
												MonsterEncounter(90, 21, 8, "Bunillaby", 234, 700, false);
												Space();
												MonsterEncounter(85, 19, 9, "Fuzilite", 786, 903, false);
												Space();
												...
												Enter();
												MonsterEncounter(84, 8, 7, "Talus Large", 4534, 880, false);
												Space();
												//Cabin
												if(noCabin == false)
												{
											...
											case 4:
												...
												Writer("You keep yourself on your toes as the precipice is obliterated by the slashing of mighty swords.", 3);
												Color("null");
												Enter();
												...
												Color();
												Space();
												MonsterEncounter(140, 23, 18, "[1;34mMonotonous Mark[1;31m", 9000F, 4000, true, weight: new int[] {2, 3, 1, -3}, powerAttackHit: 30, powerAttack: "Chain Slicer");
												Space();
												...
												Writer("After that, he jumps away; far into the mountain peak.", 3);
												Enter();
												//rest
												...
												Enter();
												MonsterEncounter(100, 28, 6, "Monster Whipper Brock", 1400F, 2700, true, false, true, 122, 14, 9, "Mad Mon \"Jon\" the Talus Massive", hasPatternTwo: true, patternTwo: new int[] {1, 1, 1, 2, 1, 1, 1, 2, 1, 2});
												Space();
									...
									case "F I V E  N I G H T S  A T  F R E D D Y Y Y ' S .  I S  T H I S  W H E R E  Y O U  W A N T  T O  B E ????  I  J U S T D O N ' T  G E E E E T  I T T T .  W H Y  D O  Y O U  W A N T  T O  S T A Y ???":
										Use();
										MonsterEncounter(1,0,0, "Sad man", 0, 0, false, false, false, 1, 0, 0, "Sad human");
										MonsterEncounter(monName: "Debug Bug", exp: 2000F, gold: 3000,attack: 0 ,hp: 700, speed: 900, doubleBattle: true, twoEnemy: false, monNameTwo: "Debug Insect", hpTwo: 400, attackTwo: 0, hasWeight: false, hasPattern: true, pattern: new int[] {1, 1, 1, 0, 1, 3, 1, 2, 1, 1}, waitTime: 2);
							    ...
							    //forests
									...
									case "forests, 3":
							      	...
							      	case 0:
							    	    ...
							    	    Space();
							    	    Writer("GUY: Hi! You're in the mines, huh? Not to be captain obvious, but you really shouldn't	be here. it's dangorous.");
							    	    Enter();
							    	    ...
							    	    switch(option) 
							    	      ...
							    	      break;
													...
													default:
														ErrorWrite();
														Writer("Unintelligeble, you just leave.");
														Enter();
														go = true;
													break;
							    	    }
							    	  ...
							    	  break;
							    	  	...
							    	  	MonsterEncounter(23, 5, 9, "MegaMadGuy", 200F, 300, false);
												...
												Enter();
												Writer("Captin: Who are you? And what gives you the right to go on this private property?!");
												Enter();
												Writer(name + ": No need for alarm. I'm just you friendly neigborhood " + name + ".");
												Enter();
												ThrDot();
												Space();
												Writer("Captin: >:(", 2);
											...
											case 6:
												...
												Enter();
												Writer(name + ": Oh crap. Now I have to swim hundreds of miles! This is just fricking great!");
												Enter();
												...
												if(noCabin == false)
												{
													...
													while(stooper != true)
													{
														switch(option)
														{
															...
															case "2":
																Space();
																Writer("CabinMaster: No? Well you'll regret it! But there is more too! I have a plethera of supplies, and can I interest you with them?");
																Space();
																Use();	
																stooper = true;
															break;
									...
									case "hills, 2":
										...
										switch(area)
										{
							      		...
							      		Space();
												...
												Enter();
												Writer(name + ": PLease...something else. That damn Sake makes me sick.");
												Enter();
												Writer("Bartender: Hope you are aren't suggesting my Sake is bad, are you?");
												Space();
												Writer(name + ": No, I'm not.");
												Enter();
												Writer("Bartender: Ok, then. How about you buy somethn' instead? We are also a cabin.");
												Enter();
											...
											case 2:
												...
												Enter();
												Writer(name + ": If only I had grown up here...so peaceful...");
												Enter();
												Writer(name + ": Certainly not like back-");
												Space();
												...
												switch(option)
												{
													...
													default:
														Writer("It looks as if it doesn't even understand you.");
													break;
												}
												...
												Enter();
												Writer(name + ": Bet they sense with heat vision...I got it!");
												Enter();
											...
											case 5:
												...
												Writer(".", 2);
												Thread.Sleep(900);
												Writer("CTYHO33CNJ80A8YXZY6P847PYCYYPVRRJNM544FS9HDD0143RF49CH5TXSYBZM4TW3LU68KF1LSFBIQSQLDFZ3TCYBD2KT1IL6C5S5URSJXN5KLM5137VW5N27G8KGZVZ25NW9C977LTPJHRLKQQFO36R4WB9C79XXS7", 2);
												Thread.Sleep(1000);
												Writer("-DEATH", 2);
												Space(3);
												Thread.Sleep(3000);
											...
											case 8:
												...
												Enter();
												Writer("On its head, you see a code name that reads 'FG5432-MURDERER'. The monster looks at you with a glare that reads the feeling of anger old, lasting pain; completely livid through clear acosiation of you being a human.");
												Enter();
												Color("bold");
					...
					else if(Chose == "2" && hasStarted == true)
					{
						Space();
						Console.Clear();
						stop = false;
					...
					else if(Chose == "1" && hasStarted == false)
					{
						Space();
						Console.Clear();
						if(hasStarted == false)
