	...
	public partial class Functions
	{
		...
		public static void EndGame()
		{
			...
			else if(From[2] == true)//forests Mountains
			{
				if(ending[1] == false)
				{
					...
					Enter();
					Writer("In the distance, you see a silhouette of a figure, tall and strong. Massive in stature and awesome in strength, bulging muscles coverning his frame.");
					Enter();
					Writer("Man the Man: Little man, why you come here?");
					Enter();
					Writer(name + ": Why do you have a russian accent? Isn't this place French?");
					Enter();
					Writer("Man the Man: Quiet Little man. I know who I am and yet you no NOTHING. I wil grind you into litle tiny part. You will never see your mama again, fied.");
					Enter();
					MonsterEncounter(160, 25, 15, "Man the Man", 3000F, 1200, true);

					Space();
					Writer("Man the little man: Raugh! Big man, you are powerful! I never think you to be powerful, big man. In sight of you, I am tiny.");
					Enter();
					Writer(name + ": Ok. So anyway, where the FRICK is THE DRAG-");
					ThrDot();
					Space();
					...
					Enter();
					Writer("A massive dragon the size of a quarter of the metropolis silhouette's the sky. Climbing a tower, smashing another with its massive wings, it's glowing eyes illuminating its crimson red-stained mouth with the shreaded clothing of its victims swaying in the wind. It's body red as ruby, its belly yellow as a fine topaz-gold, its body is magestic in the very definition of the word, only uncomplimented by its cruel carnivorous nature.");
					Enter();

					Writer(name + " [in awe]: Oh my God...");
					Enter();
					Writer("Man the little man: You came for DRAGON, no? Do not fear innevitable, no? Stop quivering like a little man.");
					Enter();
					Writer(name + ": Hmph.");
					Enter();
					Writer("Man the little man: Well, unice to see you. Hope you die so I get Деньги!");
					Writer(name + ": Ok...?");
					Enter();

					Console.Clear();
					Writer("From the bay, you continue your journey, now litterily in sight, to THE DRAGON.");
					Enter();
					Writer("Person: My mom's in there! You have to get her out!");
					Space();
					Writer("Another Person: Please...don't let my baby die...");
					Space();
					Writer("Yet Another Person: Don't let him destroy my home!! Don't you see?! Why can't you stop it?!!");
					Enter();
					Writer("(Note: Stop naming these people 'person') STOP NAMING THESE PEOPLE PERSON!! [in tears]: Please...my dad...I beg of you...help him!");
					Enter();
					Writer(name + ": ...");
					Writer("The screams of the people aren't silent, as the dusk breaks and the sun sets on their hopes and their dreams. You carry on.");
					Enter();
					...
					Enter();
					Writer("Pirate: End of the line, bukko!");
					Writer("Before he can take the shot, you tank it with your massive greatblade Maldur.");
					Enter();
					Writer("Pirate: What eu' doin', bukkee? Tryn' steal our stoay' kil'? Ell' not toay'!");
					Enter();
					Writer("Pirate: Let's ", 2);
					Color("yellow");
					Writer("[13]", 2);
					Color();
					Writer(" em' up, mate!", 2);
					...
					Writer("Betsy: But...But how!");
					Enter();
					Writer("Betsy: We tagg teamed him...but still...lost!");
					Enter();
					Writer("Betsy: Right, Cranky?");
					Enter();
					Writer("*Cranky chillin' by being dead*");
					Enter();
					Writer("Betsy: NOOOO!!! CRANKYYYY!!!");
					Space();
					Writer("You proceed to break his neck.");
					Enter();
					Writer("The unconcious swordsman starts to wake up, probably from the commotion.");
					Enter();
					Writer("Swordsman: Reaugh...what happened...");
					Space();
					Writer("You instinctivly ready into a battle stance, startled by his overwhelming WILL.");
					Enter();
					Writer("Swordsman: Ohhh, so if it's a battle you want...IT'S A BATTLE YOU'LL GET!!!");
					MonsterEncounter(150, 75, 18, "Mark Conjure", 5600F, 4000, true);
					Space();

					Writer("Mark [tired]: huff..puff...");
					Enter();
					Writer(name + ": Why are you saying huff puff-");
					Thread.Sleep(800);
					Writer("Mark: Wow! You really are tough! I thought I could catch you by suprise by jumping up for battle, but I was wrong, I guess.");
					Enter();
					Writer(name + ": Indeed you are.");
					Color("bold");
					Writer(name + " [thinking]: How were you catching me by suprise? You said that I initiated the battle!");
					Color();
					Enter();
					Writer("Mark: So! my name's...I think...Mark? I'm...a swordsman...maybe? I dunno...my memory's all fuzzy, it's like I can't grasp onto any one of them. [embarrassed] H-How about you?");
					Enter();
					Writer(name + ": My name's " + name + ", and I am the swordsman that will defeat The Dragon.");
					Enter();
					Writer("Mark: Awesome! How about we go to dinner my treat. After all, you saved me!");
					Enter();
					Writer(name + ": Hmmph.");
					Enter();
					Console.Clear();
					Color("bold");
					Writer(name + " [thinking]: I said THE DRAGON Wrong, but he didn't care. All the swordsmen know how to say it, so something must be wrong.");
					Enter();
					//city suberbs
					Console.Clear();
					if(HP < HEARTS)
					...
					Enter();
					Writer("Mark: Feel free to shop, if you'd like!");
					Enter();
					Writer("You decide to feel free to shop, if you'd like.");
					Enter();
					Use(550, 650, 900, 720, 1540);
					Enter();
					Writer("Mark: So...where you from?");
					Enter();
					Writer(name + ": Nabletown, Massachusetts Colony. So technically I'm English.");
					Enter();
					Writer("Mark: Wow! I...may have been there before...");
					Writer("Just then, the orders came from the waiter.");
					Enter();
					Writer("Waitress: Thank you for dinning at Sunflower Garden.");
					Enter();
					Writer("Mark: Thank you!");
					Enter();
					Writer("Mark: I honestly don't remember much from where I came from. It feels like I never did. But...I also feel I'm missing something, missing a part of me. Something happened on that ship that made me loose my memory.");
					Enter();
					Writer(name + " [prying for information]: What ship? How'd you get there?");
					Enter();
					Writer("Mark [trying to avoid memory questions]: Welll...this food is delicious! [stuffing his face] Mmmmh...Ummmph...So...Delicious!");
					Enter();
					Writer(name + ": ...");
					Enter();
					...
					Writer("Mark: So, what's the plan for defeating The Dragon?");
					Enter();
					Writer(name + ": It's THE DRAGON, and why are you helping me? I have no intention of splitting the money.");
					Enter();
					Writer("Mark [puzzled]: But...you...[regaining composure] anyway, I wasn't in it for the money. I just wanted something to test my skill. Alfter all, that's what being a swordsman is all about, right?");
					Writer(name + ": Sure...but you know it'll be hard, and that's why I was wondering why you'd-");
					Enter();
					Writer("Mark is pummled to the ground.");
					Enter();
					Writer("You pull your sword out in anticipation of attack.");
					Writer("Puncher: GAHAHAHAHAHHAHAHAHAHAHAHAAAAAAAAAA!!! SOME FRESH MEAT I SEE?! WELL, I GUESS IT'S TIME FOR SOME GOOD OL' PUMMELED CHICKEN!!");
					Enter();
					Writer("Mark: Who is this guy?");
					Enter();
					Writer("Apon closer inspection, you realize something terrible.");
					Enter();
					Writer(name + ": B-big brother...?");
					Writer("Peter Puncher: " + name.ToUpper() + "...");
					Enter();
					Writer("Peter Puncher: HOW DARE YOU COME BACK TO ME??!!!");
					Enter();
					Writer("You drop your sword, stunned in true fear. Your breathing quickens, your heart rate slows, you feel your palms sweat and turn into an ocean next to your desert of a mouth.");
					Enter();
					Writer("Mark lunges at the foe, and with a single swipe does massive damage.");
					Enter();
					Writer("Pete was livid, he grabs him by the neck and punches him so hard it broke his nose.");
					Writer("You're still shaking from fear.");
					Enter();
					Color("yellow");
					Writer("Why would he do this? Why would he track us down? WHY IS HE LIKE THIS??");
					Color();
					Enter();
					Writer("Pete Puncher: Wanna know why I hate you so much? YOU THIS YOU'RE BETTER THAN EEEEEVERYBODY ELSE. YOU THINK YOU CAN TAKE EEEEVERYBODY DOWN. Well you wanna know somethn'?");
					Enter();
					Writer("He proceeds to to take a big chunk of a bite out of Mark's, and chews to his screaming. Mark then becomes unconcious.");
					Enter();
					Writer("You can't.");
					Enter();
					Writer(name + " [in shock]: You b****! That's...[trying not to vomit]...digusting!");
					Enter();
					Writer("Puncher: AHAHAHAHAHAHAHAHHAHAHA, WELL, YOU HAVE TO GET YOUR DAILY NUTRIENTS SOMEHOW, RIGHT? THIS IS HOW I DO IT!!! GAAHAHA CHAAHAH GWAHAHAHAHAHAHAHAHAHAAHHAHAAAAAAAAAAAAAAAAA!!!!!!!!");
					Enter();
					Writer("LITERAL Monster Encounter!");
					Enter();
					MonsterEncounter(340, 79, 20, "Peter Puncher the Cannibal Boxer", 4000F, 4000, true);
					Space();
					Writer("You're in blind rage. Mark is bleeding out on the floor, but he is of least concern right now. You barely know him. You barely know anyone anymore for a long time, but you're still livid with unbridled INTENT TO KILL.");
					Enter();
					...
					Enter();
					Writer("Another step. MOTHER, FATHER, BROTHER, HOW COULD YOU LIE TO ME?! HOW COULD YOU STAND BY MY SIDE AND YET STILL WRONG ME?! SEND ME AWAY?! WITH A LOOK IN YOUR EYES OF REGRET?! HOW COULD YOU????!!!!");
					Enter();
					Writer("A final step. Your sword glares, not it's normal tint of silver, but blood.");
					Enter();
					Color("red");
					Writer("You slash at his feet, abutating them.");
					Writer("Peter: PLEASE STOP!!! GRAAAUUUGHH! IT HURTS! IT HURTS!");
					Enter();
					Writer("You cut off his hands. His red blood only reminding you of what you did to him. To father.");
					Enter();
					Writer(name + " [in his head, going ballistic]: No, HE DESERVED IT!! THAT DRUNKARD DID NOT DESERVE ANOTHER WAKING MOMENT!!");
					Enter();
					...
					Enter();
					Writer("You punch him. Again, and again, and again in what little body he has left. You crying. Everything around you is fading away. Mark, the Cabin, everything. You feel your heartbeat in your head, you're thinking back to your father who left you. You...you...YOU...");
					Enter();
					Color();
					Writer("You stop.");
					Enter();
					...
					Writer("Mark's arm is bandaged, but it seem to be that the wound wasn't really that bad.");
					Enter();
					Writer("Mark: I must've tasted like crap, huh? You ok? I saw what you did to that cannibal.");
					Enter();
					Writer("You look at your hands. Dired and wet blood stretch all the way to your ankles, the body you'd been pummling more pulpish than Mark's face. Your knuckles are stinging, if not bleeding. It's hard to tell with all of Pete's blood.");
					Enter();
					Writer(name + " [hyperventilating]: I...sorry...I...I was...I'm...!");
					Enter();
					Writer("Mark hugs you as he winces from pain. His arm is still wet with blood.");
					Enter();
					Writer("Mark: It's ok. Whatever happens, we're a team.");
					Enter();
					Writer(name + " [jokingly]: Gae.");
					Enter();
					Writer("Mark slaps you out of his arms.");
					Enter();
					Writer(name + ": But why...?");
					Enter();
					Writer("Mark: Because you're a friend. And true friends got each other's backs.");
					Writer("Mark [jokingly]: Which means you owe me one!");
					Enter();
					Writer(name + ": Grrr...");
					Enter();
					...
					//imprisioned
					Console.Clear();
					Writer("Mark: Rrraaughh...");
					Space();
					Writer("Mark wakes up.");
					Enter();
					Writer("Mark [confused]: Guuagghh...Where...am I?");
					Enter();
					Writer("Mark looks around to see his inprisionment; his cage. Although he was liked birds, he never wanted to be in their shoes.");
					Enter();
					Writer("Mark: Well, what a predicement, huh?");
					Enter();
					Writer(name + ": I know, right?");
					Enter();
					Writer("Mark turns around to see you, drawsy and whipped, sitting cross-legged on the floor with your back turned to him; only giving a backward glace back.");
					Enter();
					Writer("Mark: What...what did they DO you you?");
					Enter();
					Writer(name + ": They knocked me unconcious. Guess to hell with necessary force policy.");
					Writer("Mark: How could they do that?");
					Enter();
					...
					Enter();
					Writer("Macaroni Speaker: *section 35, inmate 249 killed, available staff clean up the body.*");
					Enter();
					Writer("You and Mark then heard the chattering stop, and the hit of clad boots on the floor. You also see a rat crawl by.");
					Enter();
					if(WILL > 0)
					{
					...
					else
					{
						...
						Enter();
						Writer("Mark [annoyed]: You didn't have to do THAT, you know!!");
						Writer(name + ": This rat can be useful. Besides, you don't really have a relationship with it, do you?");
						Enter();
						Writer("Mark: Grrr...");
						Enter();
					}
					Writer("Using your newly found kill's spine, you slowly cut it's femur out of it's leg, shape it into a small dagger, and slowly cut the chains on your wrists and ankles.");
					Enter();
					Color("bold");
					...
					Enter();
					Color("red");
					Writer("131 HOURS LATER", 2);
					ThrDot();
					Color();
					Space(2);
					ATK -= 8;
					Writer("End of the week, and you can hear the screams of fighter pilots dying on the outside. You've loss muscle mass by a little bit of a margin, and your mental health has only deteriorated further. If not for Mark, you could've been completely insane by now. Rumor has it the Warden's boss is coming to specifically see the brother of Pete the Puncher, and how he managed to be off the grid for so long. Turns out, it's gonna happen tomorrow.");
					Enter();
					//breakout
					Console.Clear();
					Color("red");
					...
					Enter();
					Writer("Governor: Greetings, " + name + ". I am the Prison Governor. It is a..not so much an honor...but an experience to meet you.");
					Enter();
					Writer(name + " [concerned]: What's happening out there? And what are you doing to make?!");
					Space();
					Writer("Governor: All will be answered in time, " + name + ", but for now, I would like to have a chat with you.");
					Enter();
					Writer("Mark struggles as the Governor attempts to hold him.");
					Writer("Mark: Don't listen to him! He has alternative motives! ALTERNATIVE MOTIVES!!");
					Enter();
					Writer("Governor: Quiet, you.");
					Writer("He, with one swift strike to the neck, knocks Mark out.");
					Enter();
					Writer(name + " [angered]: What do you want?!");
					Space();
					Writer("Governor: Well, simple, really. I want you.");
					Enter();
					Writer(name + ": I'm not gay.");
					Enter();
					Writer("Governor [amused, aroused??]: Oh, no. On the contraire, " + name + ". I mearely want your power, your skill to enforce. The aura you give off is strong, confident. Something the police force could use in their ranks.");
					Enter();
					Writer(name + ": I'm still getting gay vibes, but whatever. I'm not a policeman. I'm a mercinary, and swordsman like no other. I wouldn't need to get a paycheck and a uniform to be great, to be remembered. I can do that on my own.");
					Enter();
					Writer(name + ": That's how I always rolled...");
					Enter();
					Writer("Governor [erect]: Well, I never expected a yes from you, so I'll just have to convince you over a period.");
					Enter();
					Writer("Governor: By any means necessary.");
					Enter();
					Writer("The Governor proceeds to punch you in the gut, and while it knocks the wind out of you, it does less than expected. You've seen Bushables his harder than this.");
					Enter();
					//goTime
					Writer("Governor: Now, I'll visit you once this...situation...is under control.");
					Space();
					Writer("Mark then turns the Governor's neck into an angle.");
					Enter();
					Writer("Mark: " + name + ", we gotta go.");
					Space();
					Writer(name + ": Right!");
					...
					Space();
					Writer(name + ": Dammit, I don't have my sword!");
					Space();
					Writer("Mark: You don't need a sword to be awesome! Just watch!");
					Enter();
					Writer("The gaurds pull out extendable metal rods and prepare for battle themselves.");
					Enter();
					Writer("Gaurd: PULL OVE...I mean STAND DOWN!!");
					Space();
					Writer("Femboy Gaurd: Y-Yeah!");
					Enter();
					MonsterEncounter(40, 20, 8, "Gaurd #718", 9000F, 400, true, true, true, 35, 12, 8, "(Femboy) Gaurd #920");
					Space();
					Writer(name + ": I'm Not as strong as I should be...");
					Space();
					Writer("Mark: But they're crappers, too, so come on! We still have to figure out where to get our stuff!");
					Enter();
					Writer("You run through the clostrophobic halls, stopping for nothing, looking through room after room. You find a bathroom, the workrooms, and an office.");
					Enter();
					Writer("OH CRAP AN OFFICE-");
					Thread.Sleep(600);
					MonsterEncounter(70, 40, 9, "Gaurd #345", 4500F, 600, true, true, false);
					Space();
					Writer("Mark: That was a stupid idea.");
					Space();
					Writer(name + ": Tell me about it...");
					Enter();
					Writer("Continuing down the halls, you find the clothing room, and some gaurds with the Warden.");
					Enter();
					Writer("Warden: You're not escaping. I've set everything as it should be, and you are merely going by memory of your short week here. Perhaps next time you'll have a better knowledge of this place. Too bad you'll be in for life after this.");
					Enter();
					Writer("Mark: We ain't surrendering to your hunky-dunky sorry arse! I'll stick my finger up your ass before you get the pleasure of bringing us behind bars!");
					Space();
					Writer(name + ": Besides, you've been using lethal force this entire time. Were you really trying to capture us, or is it something else?");
					Enter();
					Writer("Warden: Grrr...");
					Space();
					...
					Enter();
					Writer(name + ": Mom! I'm home!");
					Space();
					Writer("Mom [divided attention on computer]: Welcome home, Sammy. How was your day out?");
					Enter();
					Writer(name + "'s father enters the room, his face stern and unshaven with a sleevless undershirt covered in sweat.");
					Space();
					Writer("Father: Beer?");
					Space();
					Writer(name + " [unamused]: Here, Dad.");
					Space();
					Writer(name + " then hands in the 12-pack of beer.");
					Enter();
					Writer("Father: Should make these in 24-packs...");
					Writer("He then leaves the room, opening the pack with his bear hands, and immediantly gobbling a whole bottle.");
					Enter();
					Writer(name + ": Mom! look what I found!");
					Space();
					Writer("The exited child then unclotches his hand to reveal a bettle with pale eyes.");
					Enter();
					Writer(name + ": It's so cool, isn't it Mom?");
					Enter();
					Writer("Mom: That's great honey, but I need to work on this right now. There's a due date for this project, and I have to present the city papers to the clients by Fireyday.");
					Space();
					Writer(name + " [dissapointed]: But Mooom, it's only Tanderday! You have plenty of time!");
					Enter();
					Writer("Mom: I'm sorry honey...why don't you talk to your father?");
					Space();
					Writer(name + " [adamant]: But I HATE Dad! He just drinks that expired grape juice all day? I tasted it once, and I spit it out because it was NASTY!!");
					Enter();
					Writer("Mom [shocked]: YOU DRANK WI-expired grape juice?!");
					Space();
					Writer(name + " [looking down]: I'm sorry...");
					Enter();
					//escape
					Console.Clear();
					Color();
					...
					Writer(name + ": Raughh...");
					Enter();
					Writer("Mark: You ok, " + name + "?");
					Enter();
					Writer(name + ": Yeah, I'm FINE!!");
					Space();
					Writer("You say as to throw a mean left hook at the Warden, which he cleanly blocks and holds with his hand.");
					Enter();
					Writer("Warden: It'll take more than that to bring me down, fool!");
					Enter();
					ItemUser();
					MonsterEncounter(260, 50, 12, "Thug Penetenary Prison Warden Roger Green", 12000F, 9000, true,true, true, 40, 25, 5, "Gaurd #3 (Benny Green)");
					Space();
					Writer("Mark: Wooohoo!! THAT'S waht you get for trying to take us down!");
					Enter();
					Writer(name + ": Hmph.");
					Space();
					Writer("You then both gather your gear, increasing your attack to normal.");
					ATK += 8;
					Enter();
					Writer("Mark: So now what?");
					Space();
					Writer(name + ": I dunno. Guess we leave and go to THE DRAGON.");
					Enter();
					Writer("Governor: I don't think so...");
					Enter();
					Writer("You both look behind you, revealing a massive War Robots-style battle robot that blasted through the small door that went into the prisoner confiscasions room.");
					Enter();
					Writer(name + ": Dammit, can't you just leave us alon?! Whad'd we do to you besides what we're going to now!");
					Space();
					Writer("Governor: What you did is threaten my perfect crime-er penetentary streak!");
					Enter();
					Color("bold");
					Writer("NOW FALL AT MY FEET!");
					Color();
					Enter();
					ItemUser();
					MonsterEncounter(470, 90, 7, "War Robot Governor", 9000F, 4000, true, true, false);
					Space();
					Writer("Governor: NOOOOOOOOOOOOO!!! HOW COULD THIS BEEE???!!!");
					Enter();
					Writer(name + ": Dude, it's not a big deal-");
					Thread.Sleep(1000);
					Space();
					Writer("Governor: NOOOOOOOOOOOOOOOOOO!!!!");
					Enter();
					Writer("Governor: If I can't have MY WAY...I'LL LET NO ONE HAVE THEIR WAY!!!");
					Enter();
					Writer("Mark: What-");
					Thread.Sleep(900);
					Console.Clear();
					...
					Enter();
					Writer("The governor is laying in a net, surrounded by scrap from his robot machine. Above him is a bright and extravigently clothed weebo-looking teen with a katana on his hip.");
					Space();
					Writer("Swordsman A: Well, that's been taken care of.");
					Enter();
					Writer("Another anime character-dressed swordsman, this time with duel swords and boobs, drops from the ceiling.");
					Space();
					Writer("Swordswoman S: So we finally found this sneaky critz. Took us long enough. Were's the captain?");
					Enter();
					Writer("Just then, a 6 foot 7 inch handsome looking swordsman in a black coat appears behind the women.");
					Enter();
					Writer("Swordsman Captain: I'm right here.");
					Enter();
					Writer("Swordswoman S: You really should stop doing that.");
					Enter();
					Writer("Mark [enthusiastic]: WOW!! COOL!!");
					Space();
					Writer(name + " [angry about his win being taken away]: HEY!! WHO ARE YOU??");
					Enter();
					Writer("Swordsman A: Oh? Hah! I guess we didn't introduce ourselves.");
					Enter();
					Writer("They all proceed to do ridiculous poses.");
					Space();
					Color("green");
					Writer("Swordsman A: I'm the awesome possum: Breys!");
					Space();
					Color("red");
					Writer("Swordswoman S: I am the elegant knight of the dark: Sapphire!");
					Space();
					Color("blue");
					Writer("Swordsman Captain: I'm the swordsman of the west, the one to defat the Dragon with my crew: Captain!");
					Enter();
					Color("bold");
					Writer("Breys, Sapphire, and Captain together: And we are...Rumble Group!");
					Color();
					//crew
					Enter();
					Writer(name + " [dumbfounded]: ...");
					Space();
					Writer("Mark: WOW...!");
					Enter();
					Writer("Breys: Pretty good, eh? And what's your names?");
					Enter();
					Writer(name + ": I don't even WANT to accosiate with you-");
					Thread.Sleep(1000);
					Space();
					Writer("Mark: His name is " + name + ", and my name is Mark something!");
					Enter();
					Writer("Breys: You don't know your own last name?");
					Space();
					Writer("Mark: I kinda have amnesia I think, so I don't know anything much of before I got here.");
					Enter();
					Writer("Breys: I see...");
					Enter();
					Writer("Sapphire: Well, we can always try and get those memories back!");
					Enter();
					Writer("Captain: We cannot.");
					Space();
					Writer("Breys and Sapphire simulateusly: WHAT?!");
					Enter();
					Writer("Breys [pointing to Mark]: He needs help! We can't just leave him? That's not what the Rumble Group does!");
					Enter();
					Writer("Captain: The rumble group is meant to defeat the Dragon. Nothing more or less was required.");
					Enter();
					Writer("Breys: C'mon! Don't be a wet noodle!");
					Enter();
					Writer(name + ": Ok, what the HELL is happening?!");
					Enter();
					Writer(name + ": You guys just barge in and decide the fate my friend? Uncool!");
					Enter();
					Writer(name + ": And worst of all, you guys are planning on defeating THE DRAGON, what?!");
					Enter();
					Writer(name + ": And Mr. Cappy-Daffy over here isn't even pronouncing it right!!");
					Enter();
					Writer(name + ": You guys can't barge into here and steal ALL the glory and just excpect me, Sam- I mean " + name + ", and I'm a mercinary. This guy probably has a booty, and I want to take it!!");
					Enter();
					Writer("Sapphire: That's not what we're doing at all! We're trying to help you!");
					Enter();
					Writer(name + ": Well NEWSFLASH!! We! Don't! Need! Your! HELP!!");
					Enter();
					Writer("Mark: " + name + ", why are you being so mena? They just stopped up from being evaporated!!");
					Enter();
					Writer(name + ": Because I HATE it when people think they have the moral highground!");
					Enter();
					Writer("Mark: Well they don't they just want to help!");
					Enter();
					Writer(name + ": How sure are you of that?!");
					Enter();
					Color("bold");
					Writer("Captain: ENOUGH!!");
					Color();
					Enter();
					Writer("Captain: They just wanted to help you. Nothing more, nothing less.");
					Space();
					Writer(name + ": Grrr...");
					Enter();
					Writer("Captain: ...You know what? Let's go into the city. There, we can reconvine at a resturant. My treat. We'll talk there.");
					Space();
					Writer("Sapphire & Breys simulateusly: What?!");
					Enter();
					Writer(name + ": WE WOULD-");
					Thread.Sleep(900);
					Space();
					Writer("Mark: Never NOT accept your offer!");
					Enter();
					Writer("Captain: Excelent. We'll meet at the Crispy Crab.");
					Enter();
					Writer("They proceed to jump through the ceiling.");
					Enter();
					Writer("Mark [concerned]: " + name + ", I feel like there's something you're not telling me. Everything ok?");
					Enter();
					Writer(name + ": ...");
					Enter();
					...
					bountiesCleared += 1;
					Enter();
					Writer("Mark: " + name + ", I've been meaning to ask...");
					Enter();
					Writer(name + ": Hm?");
					Enter();
					Writer("Mark: N-nevermind.");
					Enter();
					...
					Enter();
					Writer("Mark: Wow! I guess we'll be staying here for a while!");
					Space();
					Writer(name + ": Eh.");
					ending[1] = true;
				}
				else if(ending[1] == true)
				{
					//city hub
					Console.Clear();
					while(true)
					{
						...
						switch(option)
						{
							...
							case "5":
								...
								if(both == true)
								{
									Writer("You and " + fMark3 + " enter the Hunt Zone.");
									Enter();
								}
								else
								{
								...
								if(firstTime[7] == true)
								{
									...
									Enter();
									Color("cyan");
									Writer("It's free for you, so good luck!");
									Enter();
									Color();
									firstTime[7] = false;
								}
								...
								while(stop != true)
								{
									for(int i = 0; i < 51; i++)
									{
										if(HP > HP/2)
										{
											...
											{
												Space();
												Writer("Super deep in now. Don't even know where we are...");
											}
											else if(i == 50)
											{
												Space();
											...
											MonsterEncounter((enemy.HP + (i * 2)), (enemy.SPE + (i * 4)), (enemy.ATK + (i * 3)), enemy.name, (i * 200), 10, false, both, teamMate: teamer);
										}
										else
										{
											Space();
		...
		public static void Greetings()
		{
			if(name.Replace(" ", "") == "")
				...
				{
					Space();
					Writer("Krillin: For the last time Goku I'm not a oopaloopa!");
				}
